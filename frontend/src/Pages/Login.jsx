        ...
        <form onSubmit={handleLogin} className="form">
          ...
          <div className="login-with">
            <div className="button-log" onClick={handleGoogleSignIn}>
              <svg className="icon" height="56.6934px" width="56.6934px" viewBox="0 0 56.6934 56.6934" xmlns="http://www.w3.org/2000/svg">
                <path d="M51.981,24.4812c-7.7173-0.0038-15.4346-0.0019-23.1518-0.001c0.001,3.2009-0.0038,6.4018,0.0019,9.6017 
                  ...
                  C52.5807,33.3171,52.7498,28.8064,51.981,24.4812z" />
              </svg>
            </div>
          </div>
