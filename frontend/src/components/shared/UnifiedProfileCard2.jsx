...
const UnifiedProfileCard2 = ({ serviceData, mode = 'view', onUpdate }) => {
  ...
  useEffect(() => {
    if (serviceData) {
      setFormData({
        name: serviceData.company || '',
        email: serviceData.email || '',
        phoneNumber: serviceData.phoneNumber || '',
        profileImage: serviceData.image || '',
        description: serviceData.description || '',
        pricingModel: serviceData.price || '',
        availability: serviceData.availability
          ? Object.entries(serviceData.availability)
              .map(([day, hours]) => `${day}: ${hours.join('-')}`)
              .join('; ')
          : '',
        serviceTypes: serviceData.serviceTypes?.join(', ') || '',
  ...
  const providerData = serviceData || provider || defaultData;
        ...
        <Card.Body>
          <div className="d-flex flex-column gap-3">
            <div className="d-flex align-items-center gap-3">
              ...
              />
              <div>
                <h5 className="mb-1">{providerData.company}</h5>
...
export default UnifiedProfileCard2;